.. |discussion-icon| raw:: html

   <i class="fa-regular fa-comments"></i>

.. |collaboration-icon| raw:: html

   <i class="fa-solid fa-users"></i>
   
.. |contributing-icon| raw:: html
...
- development of new OWL modules
- integration of domain-specific models into OWL ecosystem
- joint research projects
- application of OWL tools in real-world water systems


Open Water Lab (OWL) is an open-source ecosystem that grows through
